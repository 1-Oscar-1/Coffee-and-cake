(function () {
    ...
    var metLightbox = {
        ...
        lightbox: function (imagen) {
            //Obtenemos los estilos de un elemento y
            //requiere dos parametros, el elemento y el pseudoelemento
            propLightbox.imagenSrc = window
                .getComputedStyle(imagen, null)
            ...
            propLightbox.modal
                ...
                .setAttribute("class", "imagen-modal");
            ...
            propLightbox.modal.innerHTML +=
                '<i id="cerrar_modal" class="fa fa-times"></i>';
